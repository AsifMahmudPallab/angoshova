...
/* menu offcanvas */
 let fullMenu = document.querySelector('.header-menu > ul');
 let offCanvas = document.querySelector('.offcanvas-menu');
 let offCvsWpr = document.querySelector('.offcanvas-menu-wrapper')

 if(window.innerWidth < 768){
    offCanvas.appendChild(fullMenu);
    document.querySelector('#menu-button').addEventListener('click',()=>{
        offCvsWpr.classList.toggle('show');
        
        document.querySelector('.logo-box')
    })

    document.querySelector('.offcanvas-cancel').addEventListener('click', ()=>{
        offCvsWpr.classList.toggle('show');
    })
 }  
